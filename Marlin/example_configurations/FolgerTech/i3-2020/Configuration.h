...
#define STRING_CONFIG_H_AUTHOR "(Phil Ramirez, Folgertech FT-5 Stock 1.1.9)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FT-5 Marlin 1.1.9"
